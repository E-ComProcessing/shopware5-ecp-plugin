...
use EComprocessing\Models\Config\Methods;
use EComprocessing\Models\Config\Repository;
use Shopware\Components\Model\ModelManager;

/**
 * Provides the settings for the ecomprocessing Payment Methods
 *
 * Class Config
 * @package EComprocessing\Components\Services
 */
class EcomprocessingConfig
{
    /**
