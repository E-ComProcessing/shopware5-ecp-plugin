...
namespace EComprocessing\Components\Base;
 ...
 *
 * Class SdkService
 * @package EComprocessing\Components\Base
 *
...
{
    /**
     * Recognizable string that ecomprocessing Uses for the transaction ids
     */
    ...
    /**
     * E-Comprocessing Plugin Config Service
     *
     * @var EcomprocessingConfig $configService
     */
     ...
     *
     * @var EcomprocessingLogger $pluginLogger
     */
     ...
     *
     * @param EcomprocessingConfig $configService       E-Comprocessing Config Service
     * @param string             $pluginName          The name of the Plugin
     * @param EcomprocessingLogger $pluginLogger        The plugin Logger Service
