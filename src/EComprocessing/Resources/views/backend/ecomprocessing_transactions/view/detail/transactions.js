...
Ext.define('Shopware.apps.EcomprocessingTransactions.view.detail.Transactions', {
    name: 'ecomprocessing-order-transactions',
    extend: 'Ext.container.Container',
    padding: 10,
    title: 'ecomprocessingTransactions',
    ...
    transactionsStore: function () {
        ...
        return Ext.define('Shopware.apps.Ecomprocessing.store.EcomprocessingTransactions', {
            ...
            proxy: {
                type: 'ajax',
                url: 'EcomprocessingTransactions/list?orderId=' + me.record.data.number,
                reader: {
                    type: 'json',
                    root: 'data',
                    totalProperty: 'total'
    ...
    sendReferenceRequest: function (data, success, always) {
        ...
        Ext.Ajax.request({
            url: 'EcomprocessingReferenceTransaction/reference_transaction',
            params: data[0],
