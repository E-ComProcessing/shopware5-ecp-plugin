 ...
 *
 * Class Methods
 * @package EComprocessing\Models\Config
 *
 * @SuppressWarnings(PHPMD.CamelCasePropertyName)
 * @SuppressWarnings(PHPMD.TooManyFields)
 * @codingStandardsIgnoreStart
 * @ORM\Entity(repositoryClass="Repository")
 * @ORM\Table(name="ecomprocessing_config_methods", uniqueConstraints={@ORM\UniqueConstraint(name="idx_option_methods", columns={"options", "methods"})})
