 ...
 */
class EcomprocessingOrderTransactions implements SubscriberInterface
{
    /**
     * @var string
     */
    ...
    public function onOrderPostDispatch(\Enlight_Event_EventArgs $args)
    {
        ...
        if ($request->getActionName() == 'index') {
            $view->extendsTemplate('backend/ecomprocessing_transactions/app.js');
        }

        if ($request->getActionName() == 'load') {
            $view->extendsTemplate('backend/ecomprocessing_transactions/view/detail/window.js');
        }
    }
}
