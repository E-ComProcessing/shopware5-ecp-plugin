...
namespace Ecomprocessing\Components\Methods;
...
use Ecomprocessing\Components\Models\PaymentData;
use Ecomprocessing\Components\Services\EcomprocessingConfig;
use Ecomprocessing\Components\Services\WpfTokenizationService;
use Ecomprocessing\Components\Services\ThreedsService;
use Ecomprocessing\Models\Transaction\Repository;
use Ecomprocessing\Models\Transaction\Transaction;
 ...
 * @package Ecomprocessing\Components\Methods
 */
class CheckoutService extends SdkService
{
        ...
        $request
            ...
            ->setReturnSuccessUrl(
                $paymentData->getSuccessUrl() . '&' . http_build_query([
                    EcomprocessingPaymentAttributes::RETURN_ACTION_PARAM_TRANSACTION_ID => $transactionId
                ])
            )
            ->setReturnPendingUrl(
                $paymentData->getSuccessUrl() . '&' . http_build_query([
    ...
    protected function getCheckoutTransactionTypes()
    {
        ...
        $pproSuffix    = EcomprocessingConfig::PPRO_TRANSACTION_SUFFIX;
        ...
        $aliasMap = array_merge($aliasMap, [
            EcomprocessingConfig::GOOGLE_PAY_TRANSACTION_PREFIX . EcomprocessingConfig::GOOGLE_PAY_PAYMENT_TYPE_AUTHORIZE =>
                Types::GOOGLE_PAY,
            EcomprocessingConfig::GOOGLE_PAY_TRANSACTION_PREFIX . EcomprocessingConfig::GOOGLE_PAY_PAYMENT_TYPE_SALE      =>
                Types::GOOGLE_PAY,
            EcomprocessingConfig::PAYPAL_TRANSACTION_PREFIX . EcomprocessingConfig::PAYPAL_PAYMENT_TYPE_AUTHORIZE         =>
                Types::PAY_PAL,
            EcomprocessingConfig::PAYPAL_TRANSACTION_PREFIX . EcomprocessingConfig::PAYPAL_PAYMENT_TYPE_SALE              =>
                Types::PAY_PAL,
            EcomprocessingConfig::PAYPAL_TRANSACTION_PREFIX . EcomprocessingConfig::PAYPAL_PAYMENT_TYPE_EXPRESS           =>
                Types::PAY_PAL,
            EcomprocessingConfig::APPLE_PAY_TRANSACTION_PREFIX . EcomprocessingConfig::APPLE_PAY_TYPE_AUTHORIZE           =>
                Types::APPLE_PAY,
            EcomprocessingConfig::APPLE_PAY_TRANSACTION_PREFIX . EcomprocessingConfig::APPLE_PAY_TYPE_SALE                =>
                Types::APPLE_PAY,
        ]);
