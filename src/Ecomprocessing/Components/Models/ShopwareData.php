...
namespace Ecomprocessing\Components\Models;

use Ecomprocessing\Components\Base\DataAdapter;
 ...
 * Class ShopwareData
 *
 * @package Ecomprocessing\Components\Models
 *
 * Setters
 *
...
class ShopwareData extends DataAdapter
{
    ...
    public function getToken()
    {
        ...
        if (!array_key_exists(EcomprocessingPaymentAttributes::RETURN_ACTION_PARAM_TOKEN, $data)) {
