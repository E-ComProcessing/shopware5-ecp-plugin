...
class Shopware_Controllers_Frontend_EcomprocessingCheckoutPayment extends FrontendPaymentAction implements EcomprocessingTokenValidation
//@codingStandardsIgnoreEnd
{
    ...
    public function payAction()
    {
        ...
        try {
            ...
            /** @var \Ecomprocessing\Components\Methods\CheckoutService $sdkService */
