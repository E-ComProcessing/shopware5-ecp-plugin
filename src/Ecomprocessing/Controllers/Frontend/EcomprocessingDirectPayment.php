...
/**
 * Class Shopware_Controllers_Frontend_EcomprocessingDirectPayment
 *
 * @SuppressWarnings(PHPMD.CamelCaseClassName)
 */
//@codingStandardsIgnoreStart
class Shopware_Controllers_Frontend_EcomprocessingDirectPayment extends FrontendPaymentAction implements EcomprocessingTokenValidation
//@codingStandardsIgnoreEnd
{
    ...
    public function payAction()
    {
        try {
            ...
            /** @var \Ecomprocessing\Components\Methods\DirectService $sdkService */
            ...
            /** @var \Ecomprocessing\Components\Helpers\TransformCreditCardData $creditCardDataTransformer */
            $creditCardDataTransformer = $this->container->get('ecomprocessing.transform_credit_card_data');

            // Save transaction to the Database
            $transactionModel = new Ecomprocessing\Models\Transaction\Transaction();
            ...
            $transactionModel->setAuthorizationToken(
                $this->Request()->getParam(EcomprocessingPaymentAttributes::RETURN_ACTION_PARAM_TOKEN)
            );
            ...
            $mode = $sdkService->getConfig()[SdkSettingKeys::MODE] ?
                EcomprocessingPaymentAttributes::PAYMENT_MODE_TEST : EcomprocessingPaymentAttributes::PAYMENT_MODE_LIVE;
    ...
    {
        return $url . '&' . EcomprocessingPaymentAttributes::RETURN_ACTION_PARAM_TRANSACTION_ID . '=' . $trxId;
    }
    ...
    {
        return $url . '?' . EcomprocessingPaymentAttributes::RETURN_ACTION_PARAM_TOKEN . '=' . $token;
    }
}
