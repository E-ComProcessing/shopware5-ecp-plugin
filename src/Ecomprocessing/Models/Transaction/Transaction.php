...
namespace Ecomprocessing\Models\Transaction;

use Shopware\Components\Model\ModelEntity;
use Doctrine\ORM\Mapping as ORM;

/**
 * Class EcomprocessingTransactionModel
 * @package Ecomprocessing\Models\Base
 *
 * @SuppressWarnings(PHPMD.CamelCasePropertyName)
 * @SuppressWarnings(PHPMD.TooManyFields)
 * @codingStandardsIgnoreStart
 * @ORM\Entity(repositoryClass="Repository")
 * @ORM\Table(name="ecomprocessing_transactions", uniqueConstraints={@ORM\UniqueConstraint(name="unique_id", columns={"transaction_id", "unique_id"})})
