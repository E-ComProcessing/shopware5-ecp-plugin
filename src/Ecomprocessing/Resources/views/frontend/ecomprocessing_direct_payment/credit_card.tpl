    ...
    <nav class="content--breadcrumb block">
        <ul class="breadcrumb--list">
            <li role="menuitem" class="breadcrumb--entry is--active">
                <h4><img class="left ecomprocessing-icon" alt="ecomprocessing Icon" src="{link file="frontend/_public/src/img/icon.png"}"> {$method}</h4>
            </li>
        </ul>
    </nav>
{/block}
...
{block name='frontend_index_content'}
    <div class="content listing--content">
        <div class="ecomprocessing-container">
            <div class="ecomprocessing-card-box">
                <div class="logo-wrapper"><img src="{link file="frontend/_public/src/img/ecomprocessing.png"}" alt="ecomprocessing Logo"></div>
                <div class="card-wrapper"></div>
                <form id="ecomprocessing_form" action="{$action}" method="post">
                    <div>
    ...
    <script>
        new Card({
            form: document.getElementById('ecomprocessing_form'),
            ...
            messages: {
                legalText: '&copy;{$smarty.now|date_format: '%Y'} ecomprocessing LTD'
            },
        ...
        document.getElementById('ecomprocessing_form').onsubmit = function(){
            var submit_btn = document.getElementById('ecomprocessing_form').elements["submit"];
